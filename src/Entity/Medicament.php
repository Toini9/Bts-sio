...
class Medicament
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=MedP::class, mappedBy="idMedDpl")
     */
    private $fkMedP;

    public function __construct()
    {
        $this->fkMedP = new ArrayCollection();
    }
    ...
    /**
     * @return Collection|MedP[]
     */
    public function getFkMedP(): Collection
    {
        return $this->fkMedP;
    }

    public function addFkMedP(MedP $fkMedP): self
    {
        if (!$this->fkMedP->contains($fkMedP)) {
            $this->fkMedP[] = $fkMedP;
            $fkMedP->addIdMedDpl($this);
        }

        return $this;
    }

    public function removeFkMedP(MedP $fkMedP): self
    {
        if ($this->fkMedP->removeElement($fkMedP)) {
            $fkMedP->removeIdMedDpl($this);
        }
